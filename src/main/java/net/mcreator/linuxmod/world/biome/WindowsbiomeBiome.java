...
package net.mcreator.linuxmod.world.biome;
...
import net.mcreator.linuxmod.particle.WindowsParticle;
import net.mcreator.linuxmod.entity.BillgatesEntity;
import net.mcreator.linuxmod.block.WindowsblockundergroundBlock;
import net.mcreator.linuxmod.block.WindowsblockBlock;
...
public class WindowsbiomeBiome extends LinuxModModElements.ModElement {
	public static Biome biome;
	public WindowsbiomeBiome(LinuxModModElements instance) {
		super(instance, 2);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-16776961).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(-16776961).withFoliageColor(10387789).withGrassColor(9470285)
						...
						.setParticle(new ParticleEffectAmbience(WindowsParticle.particle, 0.005f)).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(WindowsblockBlock.block.getDefaultState(),
								WindowsblockundergroundBlock.block.getDefaultState(), WindowsblockundergroundBlock.block.getDefaultState())));
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration(
								(new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(WindowsblockundergroundBlock.block.getDefaultState()),
										new SimpleBlockStateProvider(WindowsblockundergroundBlock.block.getDefaultState()),
				...
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(BillgatesEntity.entity, 200, 4, 4));
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.NONE).depth(0.1f).scale(0.2f).temperature(0.5f)
						.downfall(0.5f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("linux_mod:windowsbiome"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("windowsbiome_lvtd");
		...
		protected void func_227424_a_(IWorldWriter ww, BlockPos bp, BooleanProperty bpr, Set<BlockPos> sbc, MutableBoundingBox mbb) {
			this.func_227423_a_(ww, bp, WindowsblockundergroundBlock.block.getDefaultState(), sbc, mbb);
		}
	}
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("windowsbiome_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("windowsbiome_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
					...
					for (Direction direction : Direction.Plane.HORIZONTAL) {
						if (p_225576_2_.nextFloat() <= 0.25F) {
							...
							if (Feature.isAirAt(p_225576_1_, blockpos)) {
								BlockState blockstate = WindowsblockBlock.block.getDefaultState();
